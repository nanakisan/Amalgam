...
public class AmalgamStack extends FluidStack {
    ...
    public AmalgamStack(int amount, PropertyList pList) {
        ...
        // here we store the property list in the FluidStack's "tag" variable,
        // which is an NBTTagCompound
    ...
    public static AmalgamStack loadAmalgamStackFromNBT(NBTTagCompound nbtComp) {
        ...
        PropertyList pList = new PropertyList();
        // Storing propertyList info in the base class 'FluidStack's tag
        // variable. This variable is saved to the "Tag" tag in NBT
