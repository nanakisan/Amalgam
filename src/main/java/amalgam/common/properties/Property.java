...
public class Property {
	...
	public enum ComboType{
		...
		QUADAVERAGE // this is the default method of combination, it shifts towards higher values
	}

	private static HashMap<String, Property> properties = new HashMap<String, Property>();
